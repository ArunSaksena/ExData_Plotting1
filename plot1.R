plot1 <- function()  {
	...
	names(working_Data) <- c("Date", "Time", "Global_active_power", "Global_reactive_power", "Voltage", "Global_intensity", "Sub_metering_1", "Sub_metering_2", "Sub_metering_3")

	## print(working_Data[1:20,])
	## Launch Graphics Device

	png(filename = "plot1.png", width = 480, height = 480)

	with(working_Data, hist(working_Data$Global_active_power, xlab = "Global Active Power (kilowatts)", main = "Global Active Power", col = "red"))
